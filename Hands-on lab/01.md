...
17. Set the name of the database to `WideWorldImporters`.
    ...
    ![WorldWideImporters is highlighted under Databases in Object Explorer.](https://github.com/microsoft/MCW-Data-Platform-upgrade-and-migration/blob/master/Hands-on%20lab/media/ssms-databases-wideworldimporters.png "Name the database")
