...
9. In the **Script & deploy schema** tab, review the script, then select **Deploy schema**.
   ...
   ![The Script & deploy schema tab of the Data Migration Assistant is displayed, with the generated script shown.](https://github.com/microsoft/MCW-Data-Platform-upgrade-and-migration/blob/master/Hands-on%20lab/media/data-migration-assistant-select-sources-sqlserver2008-wideworldimporters.png "Data Migration Assistant Script & deploy schema")
